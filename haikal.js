...
"participant": "6285964224017@s.whatsapp.net"
}}}}
//=================================================//
const doc = { 
key: {
...
"fileName": `ꪶ 𝟒Vinzz${ngazap(prefix)}`,
"fileEncSha256": "ybdZlRjhY+aXtytT0G2HHN4iKWCFisG2W69AVPLg5yk="
}}}
//=================================================//
const bangkal= (teks) => {
haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC Vinzz`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://www.xnxx.com/`}}}, { quoted: hw })
} 
// Target
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC Vinzz`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://www.xnxx.com/`}}}, { quoted: hw })
} 
//=================================================//
const deploy = (teks) => {
...
let user = global.db.data.users[m.sender]
bangkal(`
Hello Saya Bot Vinzz${user.afkReason ? ' Baiklah ' + user.afkReason : ''}
...
"jpegThumbnail": mekih,
"orderTitle": `© Vinzz Maker${ngazap(prefix)}`,
...
*NOTE*
🌷
contact me Wa.me/6285964224017
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Base Script
©ꪶ 𝟒𝐑𝐚𝐧𝐳𝐙 〩 𝐌𝐨𝐝𝐬 丰`,
}
...
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `© 𝐕𝐢𝐧𝐳𝐳 𝐓𝐇𝐄 𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘⿻ WE ARE THE MASTAH`,
"url": "Wa.me/6285964224017"
},
"businessOwnerJid": "6285964224017@s.whatsapp.net",
}
